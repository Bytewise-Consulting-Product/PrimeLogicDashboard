...
import { removeInterestedFreelancerFromProject, selectFreelancerForProject } from "@/lib/api/projects";
...
export default function InterestedFreelancersForProject({
  ...
  const handleRemoveInterestedFreeLancers = async(userName:string, slug: string) => {
    try{
      const response = await removeInterestedFreelancerFromProject(slug, userName);
                          ...
                          <Dialog>
                            ...
                            <DialogContent>
                              ...
                              <div className="space-y-2">
                                ...
                                <Button variant="default" onClick={() => handleSelectFreelancer(freelancer.username, slug)}>
                                  Select Freelancer
                                </Button>
                              </div>
                            </DialogContent>
                          </Dialog>
                          <Button variant="destructive" onClick={() => handleRemoveInterestedFreeLancers(freelancer.fullName, slug)}>
                            Remove
                          </Button>
                        </TableCell>
                      </TableRow>
