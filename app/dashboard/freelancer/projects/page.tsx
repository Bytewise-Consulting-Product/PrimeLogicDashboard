            ...
            <Card key={project.id}>
              ...
              <CardContent>
                ...
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-semibold ${difficultyColors[project.difficultyLevel]}`}
                  >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm">Deadline: {format(new Date(project.deadline), "PPP")}</span>
                </div>
